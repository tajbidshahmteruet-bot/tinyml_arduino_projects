# TinyML model training using DNN 🚀

This repository documents the training of models for fitting the sinewave using randomly created data, result of training.
...
![Sine Wave Demo](results/first_model_output.png)
- model_2_result describe the result of 2 hidden layer of Neural Network.
![Sine Wave Demo](results/model_2_result.png)
